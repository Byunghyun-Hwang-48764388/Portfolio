...
Automated ETL Pipeline: Built a robust pipeline on Databricks to transform raw telemetry logs into a structured "Gold" dataset optimized for behavioral modeling.

Feature Engineering: Developed custom columns such as LevelEfficiency (progression speed) and WeeklyCommitment to quantify player loyalty and growth patterns.
